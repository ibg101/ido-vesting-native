...
pub struct IDOBuyWithVestingAccounts<'a, 'b> {
    pub signer_info: &'a AccountInfo<'b>,
...
pub struct IDOClaimAccounts<'a, 'b> {
    pub signer_info: &'a AccountInfo<'b>,
...
impl<'a, 'b> TryFrom<&'a [AccountInfo<'b>]> for IDOBuyWithVestingAccounts<'a, 'b> {
    type Error = ProgramError;
...
impl<'a, 'b> TryFrom<&'a [AccountInfo<'b>]> for IDOClaimAccounts<'a, 'b> {
    type Error = ProgramError;
